...
public class FormSistema extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javarecordscontrol/imageF1.jpg"))); // NOI18N
        ...
        jLabel3.setText("F1 App Fast Laps Control");
        ...
        btnRemove1.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        btnRemove1.setText("Desempilhar");
        btnRemove1.setActionCommand("Remover");
        btnRemove1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                ...
                .addGap(89, 89, 89)
                .addComponent(btnRemove1, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel2Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(btnRemove1, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
       ...
       Recorde newRecord = new Recorde();
        newRecord.setNome(txtNome.getText());
        //crie a estrutura para receber a
        //data no formato dd/MM/yyyy
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        try {
            newRecord.setDataRecorde(sdf.parse(txtData.getText()));
        } catch (ParseException ex) {
            JOptionPane.showMessageDialog(this, "Data inválida");
        }
        newRecord.setTempo(Double.parseDouble(txtTempo.getText()));

        //Vincule a ação do botão com a classe pilha para adicionar ou não um novo recorde
        if(pilha.push(newRecord)) {
            JOptionPane.showMessageDialog(this, "Nova volta mais rápida adicionada!");}
        else{
            JOptionPane.showMessageDialog(this, "A volta é mais lenta que a última volta mais rápida!");
        }        
       exibirPilha();
       txtNome.setText("");
       txtData.setText("");
